...
// Middleware
  ...
  const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'verana864@gmail.com',
        pass: 'awyd rqmk lfzk didc' // Use your generated App Password
    }
});
...
app.post('/verify-otp', (req, res) => {
    ...
    if (otpStore[email] && otpStore[email].toString() === otp.toString()) {
        ...
        res.status(200).json({ redirectTo: `/dashboard` });  // Pass the email as a query parameter
    } else {
...
app.get('/dashboard', (req, res) => {
    ...
    if(req.session.user){
    const email = req.session.user.email;  // You could pass email as a query parameter
...
<head>
    ...
    <title>Martian Banking Dashboard</title>
...
<body>
    ...
    <div class="logo">
        <img src="uploads/Logo.png" alt="Martian Logo">
        <h2>Martian <sub class="onlinebank">Online Banking Service <sup class="onlinebank">TM</sup></sub></h2>
        <img class="profilepic" src="${userData.profile_pic}"
            alt="profilepic" onerror="this.onerror=null; this.src='uploads/default_profile.jpg';" srcset="">
    </div>

    <!-- Profile Popup -->
    <div class="profile-popup" id="profilePopup">
        <img src="${userData.profile_pic}" alt="Profile Image" onerror="this.onerror=null; this.src='uploads/default_profile.jpg';">
        <h4>${userData.name}</h4>
    ...
    <header class="navbar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="sign-up">Apply for New Martian Account</a></li>
                <li><a href="Martian-loan">Martian Loans</a></li>
            </ul>
        </nav>
    </header>
    ...
    <div class="wpanel_marquee">
        <p>Customers can now make the GST payment using INB with extended time up to 23.00 hours.
            &nbsp;&nbsp;|&nbsp;&nbsp; ACCOUNT OPENING IS NOW AVAILABLE ON Martian - <a href="Login-page.html"
            ...
            services through Martian Contact Centre. &nbsp;&nbsp;|&nbsp;&nbsp; Martian never asks for your
            Card/PIN/OTP/CVV
        ...
        <div class="card-actions2">
          <form action="/send-money" method="post">
                ...
                <div class="form-group2">
                    ...
                    <select id="serviceType2" name="serviceType2">
                        <option value="limitChange">Martian@${userData.account_number}</option>
                    </select>
                </div>
  ...
  <!-- More Useful Links Section -->
    <div class="useful-links">
        ...
        <p class="new">
            Martian offers a secure online banking platform that prioritizes the safety of your financial transactions. 
            With advanced encryption technology, you can confidently manage your accounts, transfer funds, and 
            access various banking services from the comfort of your home. Martian also provides robust security 
            ...
            Martian makes online banking not only convenient but also secure. The integration of securities 
            ...
            Martian ensures that your online banking experience is secure and efficient.
        </p>
        <h2>How to Use</h2>
        <div class="how-to-use">
            <p>
                Using Martian online banking is a straightforward process designed for user convenience. To get started, 
                you need to register for online banking by visiting the Martian website. Click on the "New User Registration" button 
                ...
                Once you have your login credentials, visit the Martian online banking dashboard and log in with your 
                ...
                transactions to Martian immediately.
    
                To use the investment services, navigate to the securities section where you can view available options 
                and make transactions. Martian provides tools and resources to help you make informed investment decisions. 
                Take advantage of their research and analytics tools to track your investments and explore new opportunities. 
                Whether you’re managing personal finances or investing for the future, Martian online banking offers 
    ...
    <footer>
        <div class="footer-content">
           ...
           <p>If you face any problem related to Martian online banking, then you can visit our bank or contact our dedicated customer service team at <a href="mailto:verana864@gmail.com?subject=Write your queries&body=">Martian Customer Service</a>.</p>
        </div>
    </footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Martian Banking Customer</title>
        <link rel="icon" href="uploads/Logo.png" type="image/x-icon">
    <link rel="stylesheet" href="Style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
...
<body>
    ...
    <div class="wpanel_marquee">
        <p>Customers can now make the GST payment using INB with extended time up to 23.00 hours.
            &nbsp;&nbsp;|&nbsp;&nbsp; ACCOUNT OPENING IS NOW AVAILABLE ON Martian - <a href="Login-page.html" style="color: red;text-decoration: none;">Click
                here</a> &nbsp;&nbsp;|&nbsp;&nbsp; Mandatory Profile password change after 365 days introduced for added
            security. &nbsp;&nbsp;|&nbsp;&nbsp; Call us toll free on 1890 5434 and 5544 2222 and get a wide range of
            services through Martian Contact Centre. &nbsp;&nbsp;|&nbsp;&nbsp; Martian never asks for your Card/PIN/OTP/CVV
            details on phone, message or email. Please do not click on links received on your email or mobile asking
            your Bank/Card details.</p>
    </div>
    ...
    <section class="main-content">
        <div class="banking-section">
            ...
            <div class="info-icons">
                ...
                <a href="mailto:verana864@gmail.com?subject=Write your queries&body=">Customer Care</a>
...
<body id="login-page">
    <div class="login-box">
        <h2>Login to <h2 class="login-Martian">Martian</h2></h2>
        <form action="/login-data" method="post" id="loginForm">
            ...
            <div class="remember-me">
                ...
                <a href="varification" class="forgot-password">Forgot Password?</a>
            </div>
            <button type="submit" id="loginBtn" class="login-btn">Log In</button>

            <div class="new-user">
                <span>New User?</span>
                <a href="sign-up" class="sign-up-link">Create an Account</a>
            </div>
        </form>
    </div>
...
app.post('/sign-up-data', upload.single('profile-pic'), (req, res) => {
    ...
    const upiId = username.replace(/\s/g, '') + '@Martian';
...
app.post('/login-data', (req, res) => {
    ...
    connection.query(sql, [username, email, password], (err, results) => {
        ...
        if (results.length > 0) {
            ...
            req.session.user={email};
            res.status(200).json({ redirectTo: `/dashboard` }); // Redirect to dashboard
        } else {
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>About Martian Banking</title>
        <link rel="icon" href="uploads/Logo.png" type="image/x-icon">
    <link rel="stylesheet" href="Style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
...
<body>
   ...
   <header class="navbar">
    ...
    <div class="about-section">
        <h2>About Martian Bank</h2>
        <p>Martian Bank has a rich history dating back to 1690, when it was founded in London. Over the years, we have evolved into a leading global financial services provider, committed to helping individuals and businesses achieve their financial goals.</p>
        ...
        <h3>Contact Us</h3>
        <p>If you have any questions or would like to know more about our services, please feel free to <a href="mailto:verana864@gmail.com?subject=Write your queries&body=">contact our support team</a>.</p>
    </div>
  ...
  document.getElementById('homeLink').addEventListener('click', function(event) {
        ...
        window.location.href = '/dashboard'; // Redirect to dashboard with email
    });
    </script>
</body>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Martian Banking Services</title>
        <link rel="icon" href="uploads/Logo.png" type="image/x-icon">
    <link rel="stylesheet" href="Style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
    ...
    <section class="service-section">
        <div class="container">
            <div class="image-section">
                <img src="uploads/service.jpg" alt="Martian Services"> <!-- Add your image here -->
            </div>
            <div class="content-section">
                <h2>Martian Services</h2>
                <p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Martian Banking Donations</title>
        <link rel="icon" href="uploads/Logo.png" type="image/x-icon">
    <link rel="stylesheet" href="Style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
...
<body>
    ...
    <!-- Add more div -->
     ...
     <section class="service-section">
        <div class="container">
            <div class="image-section">
                <img src="uploads/Donation.jpg" alt="Donations with Martian"> <!-- Add your image here -->
            </div>
            <div class="content-section">
                <h2>Donations with Martian</h2>
                <p>
                    Martian Bank is dedicated to facilitating charitable donations that make a difference in communities around the world. By donating with us, you contribute to various impactful projects, from local community support to international disaster relief. Every donation, regardless of size, plays a crucial role in bringing about positive change.
                </p>
                <p>
                    We believe in transparency and accountability, ensuring that your contributions are handled with care and reach those in need effectively. With Martian, you can expect:
                </p>
                <ul>
...
<body>
    ...
    <div class="privacy-policies">
        ...
        <p>Your privacy is important to us. At Martian Bank, we are committed to protecting your personal information and ensuring that your data is handled responsibly.</p>
        ...
        <h3>Contact Us</h3>
        <p>If you have any questions or concerns about our Privacy Policies, please <a href="mailto:verana864@gmail.com?subject=Write your queries&body=">contact our support team</a>.</p>
    </div>
    <!-- Footer Section -->
    <footer>
        <div class="footer-content">
...
<body>
   ...
   <div class="terms-and-conditions">
        ...
        <p>Welcome to the Martian Banking service. By accessing our services, you agree to the following terms and conditions:</p>
        ...
        <p>Martian Bank will not be liable for any direct, indirect, or consequential damages arising out of or in connection with your use of our services.</p>
        
        <h3>5. Governing Law</h3>
        <p>These terms and conditions are governed by the laws of the jurisdiction in which Martian operates.</p>
...
<body>
   ...
   <section class="service-section">
        <div class="container">
            <div class="image-section">
                <img src="uploads/loan.jpg" alt="EpayLite in Martian"> 
            </div>
            <div class="content-section">
                <h2>Martian Loan</h2>
                <p>
                    Martian Bank offers a variety of loan options tailored to meet your financial needs. Whether you're looking to purchase your dream home, fund your education, or expand your business, Martian has the right solution for you. Our loans come with competitive interest rates and flexible repayment options, ensuring that you can find a plan that works for your budget.
                </p>
                <p>
                    We understand that securing a loan is a significant decision, which is why we are committed to providing transparent information and dedicated support throughout the process. With Martian, you can expect:
                </p>
                <ul>
...
// Route for downloading Martian General Insurance Document PDF
app.get('/download-Martian-general-insurance', (req, res) => {
    const file = path.join(uploadDir, 'download-Martian-general-insurance.pdf'); // Ensure this file exists
    res.download(file, 'Martian-general-insurance.pdf', (err) => {
        if (err) {
            console.error('File download error:', err);
            res.status(404).send('File not found.');
        }
...
// Route for downloading Martian Mutual Fund PDF
app.get('/download-Martian-mutual-fund', (req, res) => {
    const file = path.join(uploadDir, 'download-Martian-mutual-fund.pdf'); // Ensure this file exists
    res.download(file, 'Martian-mutual-fund.pdf', (err) => {
        if (err) {
            console.error('File download error:', err);
            res.status(404).send('File not found.');
        }
...
// Route for downloading Martian Life Insurance PDF
app.get('/download-Martian-life-insurance', (req, res) => {
    const file = path.join(uploadDir, 'download-Martian-life-insurance.pdf'); // Ensure this file exists
    res.download(file, 'Martian-life-insurance.pdf', (err) => {
        if (err) {
            console.error('File download error:', err);
            res.status(404).send('File not found.');
        }
...
// Route for downloading Martian Securities PDF
app.get('/download-Martian-securities', (req, res) => {
    const file = path.join(uploadDir, 'download-Martian-securities.pdf'); // Ensure this file exists
    res.download(file, 'Martian-securities.pdf', (err) => {
        if (err) {
            console.error('File download error:', err);
            res.status(404).send('File not found.');
        }
