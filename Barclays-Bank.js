...
const uploadDir = path.join('C:/Users/Sarif/Downloads/Documents/HTML _CSS & JS/Project04/uploads');
  ...
  <!-- More Useful Links Section -->
    ...
    <footer>
        <div class="footer-content">
            ...
            <p>Download DSB (Doorstep Banking) app from Play Store to avail Doorstep Banking Services or visit <a
                    href="http://www.bank.barclays">www.bank.barclays</a> and go to quick links for details.</p>
        </div>
    </footer>
...
<body>
   ...
   <header class="navbar">
    ...
    <div class="about-section">
        ...
        <h3>Contact Us</h3>
        <p>If you have any questions or would like to know more about our services, please feel free to <a href="#">contact our support team</a>.</p>
    </div>
...
<body>
    ...
    <div class="privacy-policies">
        ...
        <h3>Contact Us</h3>
        <p>If you have any questions or concerns about our Privacy Policies, please <a href="#">contact our support team</a>.</p>
    </div>
    <!-- Footer Section -->
    <footer>
        <div class="footer-content">
...
app.get('/download-block-atm-card', (req, res) => {
    const file = path.join(uploadDir, 'block-atm-card.pdf');
...
app.get('/download-doorstep-banking', (req, res) => {
    const file = path.join(uploadDir, 'doorstep-banking.pdf'); // Ensure this file exists
...
app.get('/download-barclays-general-insurance', (req, res) => {
    const file = path.join(uploadDir, 'barclays-general-insurance.pdf'); // Ensure this file exists
...
app.get('/download-nri-services', (req, res) => {
    const file = path.join(uploadDir, 'nri-services.pdf'); // Ensure this file exists
...
app.get('/download-barclays-mutual-fund', (req, res) => {
    const file = path.join(uploadDir, 'barclays-mutual-fund.pdf'); // Ensure this file exists
...
app.get('/download-barclays-life-insurance', (req, res) => {
    const file = path.join(uploadDir, 'barclays-life-insurance.pdf'); // Ensure this file exists
...
app.get('/download-barclays-securities', (req, res) => {
    const file = path.join(uploadDir, 'barclays-securities.pdf'); // Ensure this file exists
